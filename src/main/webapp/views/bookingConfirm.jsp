...
<body>
    ...
    User u = (User)session.getAttribute("confU");
    %>
    
        <div class="form">
            <h1>Thank you for doing business with us! <br><span>Here are your order details</span></h1>
			
			 <h6>Plant Name: <input placeholder="<%=pd.getName() %>" readonly></h6>
			  <h6>Order Type: <input placeholder="<%=b.getType() %>" readonly></h6>
			  <h6>Quantity: <input placeholder="<%=b.getQuantity() %>" readonly></h6>
            <h6>Order Status: <input placeholder="<%=b.getStatus() %>" readonly></h6>
            <h6>Order Total: <input placeholder="<%=b.getAmount() %>" readonly></h6>
