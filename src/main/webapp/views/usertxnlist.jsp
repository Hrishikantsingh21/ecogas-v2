...
<html>
  ...
  <body>
    ...
    <div class="container">
    <%if(session.getAttribute("usertxnl")==null) {%>
    <h3>No Booking found</h3>
    <%} %>
    
    <%if(session.getAttribute("usertxnl") !=null) {
    	List<Booking> bk = (List<Booking>)session.getAttribute("usertxnl");
    	for(Booking b : bk)
 ...
 { %>
      ...
      <div class="app-card">
        ...
        <button class="btn-1">
        <a href="/booking/user/<%=b.getOrderId() %>">View</a>
        </button>
      </div>
      <%} }%>
    </div>
